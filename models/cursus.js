...
class Cursus {
    ...
    static getListCursus(callBack) {
        connexion.query("SELECT * FROM cursus,domaine,etablissement,specialite,niveau WHERE cursus.id_domaine=domaine.id_domaine and cursus.id_etablissement=etablissement.id_etablissement and cursus.id_niveau=niveau.id_niveau and specialite.id_domaine = domaine.id_domaine",
            (err, res) => {
                if (err) throw err;
    ...
    static getCursusById(id_cursus, callBack) {
        connexion.query(
            "SELECT * FROM cursus,domaine,etablissement,specialite,niveau WHERE cursus.id_domaine=domaine.id_domaine and cursus.id_etablissement=etablissement.id_etablissement and cursus.id_niveau=niveau.id_niveau and specialite.id_domaine = domaine.id_domaine and cursus.id_cursus =?",
            [id_cursus],
            (err, res) => {
                if (err) throw err;
                return callBack(null, res);
